...
final _entities = <ModelEntity>[
  ModelEntity(
      id: const IdUid(1, 505620528449223594),
      name: 'LifeEvent',
      lastPropertyId: const IdUid(3, 2458354330712529714),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 3951819291746603147),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 7005533813585606365),
            name: 'title',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 2458354330712529714),
            name: 'count',
            type: 6,
            flags: 0)
      ],
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(1, 505620528449223594),
